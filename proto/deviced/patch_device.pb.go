...
var file_patch_device_proto_goTypes = []any{
...
func file_patch_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_patch_device_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_patch_device_proto_msgTypes[1].Exporter = func(v any, i int) any {
