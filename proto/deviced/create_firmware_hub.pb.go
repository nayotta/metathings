...
var file_create_firmware_hub_proto_goTypes = []any{
...
func file_create_firmware_hub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_create_firmware_hub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_create_firmware_hub_proto_msgTypes[1].Exporter = func(v any, i int) any {
