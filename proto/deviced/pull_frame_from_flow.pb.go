...
var file_pull_frame_from_flow_proto_goTypes = []any{
...
func file_pull_frame_from_flow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pull_frame_from_flow_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pull_frame_from_flow_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pull_frame_from_flow_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pull_frame_from_flow_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pull_frame_from_flow_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_pull_frame_from_flow_proto_msgTypes[0].OneofWrappers = []any{
		(*PullFrameFromFlowRequest_Config_)(nil),
	}
	file_pull_frame_from_flow_proto_msgTypes[1].OneofWrappers = []any{
