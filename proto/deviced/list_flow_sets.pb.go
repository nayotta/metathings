...
var file_list_flow_sets_proto_goTypes = []any{
...
func file_list_flow_sets_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_list_flow_sets_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_list_flow_sets_proto_msgTypes[1].Exporter = func(v any, i int) any {
