...
func file_stream_call_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stream_call_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_stream_call_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_stream_call_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_stream_call_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_stream_call_proto_msgTypes[0].OneofWrappers = []any{
		(*StreamCallRequest_Config)(nil),
		(*StreamCallRequest_Data)(nil),
	}
	file_stream_call_proto_msgTypes[3].OneofWrappers = []any{
