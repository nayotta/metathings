...
func (*ListRolesRequest) Descriptor() ([]byte, []int) { return fileDescriptor44, []int{0} }
...
func (m *ListRolesRequest) GetDomainId() *google_protobuf.StringValue {
	if m != nil {
		return m.DomainId
	}
	return nil
...
func (*ListRolesResponse) Descriptor() ([]byte, []int) { return fileDescriptor44, []int{1} }
...
func init() { proto.RegisterFile("list_roles.proto", fileDescriptor44) }
