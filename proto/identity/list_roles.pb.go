...
func (*ListRolesRequest) Descriptor() ([]byte, []int) { return fileDescriptor34, []int{0} }
...
func (*ListRolesResponse) Descriptor() ([]byte, []int) { return fileDescriptor34, []int{1} }
...
func init() { proto.RegisterFile("list_roles.proto", fileDescriptor34) }
