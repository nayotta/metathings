...
func (*CreateRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*CreateRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("create_role.proto", fileDescriptor9) }
