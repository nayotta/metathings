...
func (*PatchGroupRequest) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{0} }
...
func (*PatchGroupResponse) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{1} }
...
func init() { proto.RegisterFile("patch_group.proto", fileDescriptor46) }
