...
func (*CreateUserRequest) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func (*CreateUserResponse) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{1} }
...
func init() { proto.RegisterFile("create_user.proto", fileDescriptor15) }
