...
func (*PatchDomainRequest) Descriptor() ([]byte, []int) { return fileDescriptor41, []int{0} }
...
func (*PatchDomainResponse) Descriptor() ([]byte, []int) { return fileDescriptor41, []int{1} }
...
func init() { proto.RegisterFile("patch_domain.proto", fileDescriptor41) }
