...
func (*PatchProjectRequest) Descriptor() ([]byte, []int) { return fileDescriptor43, []int{0} }
...
func (*PatchProjectResponse) Descriptor() ([]byte, []int) { return fileDescriptor43, []int{1} }
...
func init() { proto.RegisterFile("patch_project.proto", fileDescriptor43) }
