...
var file_get_action_proto_goTypes = []any{
...
func file_get_action_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_get_action_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_get_action_proto_msgTypes[1].Exporter = func(v any, i int) any {
