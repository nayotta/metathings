...
func (c *deviceServiceClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/ai.metathings.service.device.DeviceService/Heartbeat", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_c51197733df9d0a1) }

var fileDescriptor_service_c51197733df9d0a1 = []byte{
