...
func (c *identitydServiceClient) GetPolicy(ctx context.Context, in *GetPolicyRequest, opts ...grpc.CallOption) (*GetPolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.identityd2.IdentitydService/GetPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identitydServiceClient) ListPolicies(ctx context.Context, in *ListPoliciesRequest, opts ...grpc.CallOption) (*ListPoliciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.identityd2.IdentitydService/ListPolicies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identitydServiceClient) ListPoliciesForRole(ctx context.Context, in *ListPoliciesForRoleRequest, opts ...grpc.CallOption) (*ListPoliciesForRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.identityd2.IdentitydService/ListPoliciesForRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identitydServiceClient) AddPolicyToRole(ctx context.Context, in *AddPolicyToRoleRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ai.metathings.service.identityd2.IdentitydService/AddPolicyToRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identitydServiceClient) RemovePolicyFromRole(ctx context.Context, in *RemovePolicyFromRoleRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/ai.metathings.service.identityd2.IdentitydService/RemovePolicyFromRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
