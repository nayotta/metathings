...
type OpPolicy struct {
	...
	Rule                 *wrappers.StringValue `protobuf:"bytes,3,opt,name=rule,proto3" json:"rule,omitempty"`
...
func (m *OpPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpPolicy.Merge(m, src)
}
...
type OpRole struct {
	...
	Policies             []*OpPolicy                      `protobuf:"bytes,6,rep,name=policies,proto3" json:"policies,omitempty"`
	Extra                map[string]*wrappers.StringValue `protobuf:"bytes,7,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
