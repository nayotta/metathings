...
func (*GetCoreRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*GetCoreResponse) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func init() { proto.RegisterFile("get_core.proto", fileDescriptor3) }
