...
func (*ListRolesForUserOnDomainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_list_roles_for_user_on_domain_70df4a716899082b, []int{0}
}
...
func (*ListRolesForUserOnDomainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_list_roles_for_user_on_domain_70df4a716899082b, []int{1}
}
...
func init() {
	proto.RegisterFile("list_roles_for_user_on_domain.proto", fileDescriptor_list_roles_for_user_on_domain_70df4a716899082b)
}

var fileDescriptor_list_roles_for_user_on_domain_70df4a716899082b = []byte{
