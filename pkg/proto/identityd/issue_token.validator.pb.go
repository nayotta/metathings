...
func (this *PasswordPayload) Validate() error {
	...
	if this.DomainName != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.DomainName); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("DomainName", err)
		}
	}
	if this.Scope != nil {
...
func (this *TokenPayload) Validate() error {
	if nil == this.TokenId {
		return github_com_mwitkow_go_proto_validators.FieldError("TokenId", fmt.Errorf("message must exist"))
	}
	if this.TokenId != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.TokenId); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("TokenId", err)
		}
	}
	if this.Scope != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Scope); err != nil {
...
func (this *IssueTokenRequest) Validate() error {
	if oneOfNester, ok := this.GetPayload().(*IssueTokenRequest_Password); ok {
		if oneOfNester.Password != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.Password); err != nil {
				return github_com_mwitkow_go_proto_validators.FieldError("Password", err)
			}
		}
	}
	if oneOfNester, ok := this.GetPayload().(*IssueTokenRequest_Token); ok {
		if oneOfNester.Token != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.Token); err != nil {
	...
	if oneOfNester, ok := this.GetPayload().(*IssueTokenRequest_ApplicationCredential); ok {
		if oneOfNester.ApplicationCredential != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(oneOfNester.ApplicationCredential); err != nil {
