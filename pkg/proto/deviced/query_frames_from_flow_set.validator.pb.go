...
func (this *QueryFramesFromFlowSetRequest) Validate() error {
	if this.Device != nil {
...
func (this *QueryFramesFromFlowSetResponse) Validate() error {
...
func (this *QueryFramesFromFlowSetResponse_Pack) Validate() error {
	if this.Flow != nil {
