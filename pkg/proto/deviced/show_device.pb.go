...
func (*ShowDeviceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_show_device_0574d0bd40a9533f, []int{0}
}
...
func init() { proto.RegisterFile("show_device.proto", fileDescriptor_show_device_0574d0bd40a9533f) }

var fileDescriptor_show_device_0574d0bd40a9533f = []byte{
