...
func (*CreateEntityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_create_entity_15d3d7f2aaed5d72, []int{0}
}
...
func (*CreateEntityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_create_entity_15d3d7f2aaed5d72, []int{1}
}
...
func init() { proto.RegisterFile("create_entity.proto", fileDescriptor_create_entity_15d3d7f2aaed5d72) }

var fileDescriptor_create_entity_15d3d7f2aaed5d72 = []byte{
