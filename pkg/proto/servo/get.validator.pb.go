...
func (this *GetResponse) Validate() error {
	if this.Servo != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Servo); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Servo", err)
		}
	}
	return nil
}
