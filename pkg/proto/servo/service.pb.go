...
func (c *servoServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.servo.ServoService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servoServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ai.metathings.service.servo.ServoService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servoServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (ServoService_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ServoService_serviceDesc.Streams[0], "/ai.metathings.service.servo.ServoService/Stream", opts...)
	if err != nil {
		return nil, err
	}
