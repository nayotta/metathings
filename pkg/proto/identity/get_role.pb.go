...
func (*GetRoleRequest) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{0} }
...
func (*GetRoleResponse) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{1} }
...
func init() { proto.RegisterFile("get_role.proto", fileDescriptor32) }
