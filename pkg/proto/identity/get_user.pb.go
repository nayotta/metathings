...
func (*GetUserRequest) Descriptor() ([]byte, []int) { return fileDescriptor33, []int{0} }
...
func (*GetUserResponse) Descriptor() ([]byte, []int) { return fileDescriptor33, []int{1} }
...
func init() { proto.RegisterFile("get_user.proto", fileDescriptor33) }
