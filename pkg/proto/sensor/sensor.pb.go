...
func (SensorState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sensor_62b5dfaead3bceca, []int{0}
}
...
func (*SensorData) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensor_62b5dfaead3bceca, []int{1}
}
...
func (*Sensor) Descriptor() ([]byte, []int) {
	return fileDescriptor_sensor_62b5dfaead3bceca, []int{2}
}
...
func init() { proto.RegisterFile("sensor.proto", fileDescriptor_sensor_62b5dfaead3bceca) }

var fileDescriptor_sensor_62b5dfaead3bceca = []byte{
