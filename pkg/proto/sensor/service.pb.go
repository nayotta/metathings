...
func (c *sensorServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/ai.metathings.service.sensor.SensorService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensorServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.sensor.SensorService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensorServiceClient) Patch(ctx context.Context, in *PatchRequest, opts ...grpc.CallOption) (*PatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.sensor.SensorService/Patch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensorServiceClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*GetDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.sensor.SensorService/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensorServiceClient) ListData(ctx context.Context, in *ListDataRequest, opts ...grpc.CallOption) (*ListDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ai.metathings.service.sensor.SensorService/ListData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
