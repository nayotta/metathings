...
func (c *streamdServiceClient) Patch(ctx context.Context, in *PatchRequest, opts ...grpc.CallOption) (*PatchResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.streamd.StreamdService/Patch", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_6131cd519a44ae1d) }

var fileDescriptor_service_6131cd519a44ae1d = []byte{
