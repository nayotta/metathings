...
// Client API for SensordService service
...
func (c *sensordServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/Create", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/Delete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) Patch(ctx context.Context, in *PatchRequest, opts ...grpc.CallOption) (*PatchResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/Patch", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/Get", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/List", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) ListForUser(ctx context.Context, in *ListForUserRequest, opts ...grpc.CallOption) (*ListForUserResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.sensord.SensordService/ListForUser", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sensordServiceClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (SensordService_SubscribeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_SensordService_serviceDesc.Streams[0], c.cc, "/ai.metathings.service.sensord.SensordService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *sensordServiceClient) Publish(ctx context.Context, opts ...grpc.CallOption) (SensordService_PublishClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_SensordService_serviceDesc.Streams[1], c.cc, "/ai.metathings.service.sensord.SensordService/Publish", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for SensordService service
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_3358ba5038754b87) }

var fileDescriptor_service_3358ba5038754b87 = []byte{
