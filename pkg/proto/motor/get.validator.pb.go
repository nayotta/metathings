...
func (this *GetResponse) Validate() error {
	if this.Motor != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Motor); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Motor", err)
		}
	}
	return nil
}
