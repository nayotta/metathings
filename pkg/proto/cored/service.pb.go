...
// Client API for CoredService service
...
func (c *coredServiceClient) CreateCore(ctx context.Context, in *CreateCoreRequest, opts ...grpc.CallOption) (*CreateCoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/CreateCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) DeleteCore(ctx context.Context, in *DeleteCoreRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/DeleteCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) PatchCore(ctx context.Context, in *PatchCoreRequest, opts ...grpc.CallOption) (*PatchCoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/PatchCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) GetCore(ctx context.Context, in *GetCoreRequest, opts ...grpc.CallOption) (*GetCoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/GetCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) ListCores(ctx context.Context, in *ListCoresRequest, opts ...grpc.CallOption) (*ListCoresResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/ListCores", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) ShowCore(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ShowCoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/ShowCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) CreateEntity(ctx context.Context, in *CreateEntityRequest, opts ...grpc.CallOption) (*CreateEntityResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/CreateEntity", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) DeleteEntity(ctx context.Context, in *DeleteEntityRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/DeleteEntity", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) PatchEntity(ctx context.Context, in *PatchEntityRequest, opts ...grpc.CallOption) (*PatchEntityResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/PatchEntity", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) GetEntity(ctx context.Context, in *GetEntityRequest, opts ...grpc.CallOption) (*GetEntityResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/GetEntity", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) ListEntities(ctx context.Context, in *ListEntitiesRequest, opts ...grpc.CallOption) (*ListEntitiesResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/ListEntities", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) ListEntitiesForCore(ctx context.Context, in *ListEntitiesForCoreRequest, opts ...grpc.CallOption) (*ListEntitiesForCoreResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/ListEntitiesForCore", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/Heartbeat", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (CoredService_StreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CoredService_serviceDesc.Streams[0], c.cc, "/ai.metathings.service.cored.CoredService/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *coredServiceClient) ListCoresForUser(ctx context.Context, in *ListCoresForUserRequest, opts ...grpc.CallOption) (*ListCoresForUserResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/ListCoresForUser", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) UnaryCall(ctx context.Context, in *UnaryCallRequest, opts ...grpc.CallOption) (*UnaryCallResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.cored.CoredService/UnaryCall", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coredServiceClient) StreamCall(ctx context.Context, opts ...grpc.CallOption) (CoredService_StreamCallClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_CoredService_serviceDesc.Streams[1], c.cc, "/ai.metathings.service.cored.CoredService/StreamCall", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for CoredService service
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_2a4fddce3b189778) }

var fileDescriptor_service_2a4fddce3b189778 = []byte{
