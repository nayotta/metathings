...
func (c *cameradServiceClient) ShowToEntity(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ShowToEntityResponse, error) {
	...
	err := grpc.Invoke(ctx, "/ai.metathings.service.camerad.CameradService/ShowToEntity", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_936e4c6756aeb1d1) }

var fileDescriptor_service_936e4c6756aeb1d1 = []byte{
