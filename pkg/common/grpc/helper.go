...
const (
	GRPC_MAX_RECV_MSG_SIZE      = 2 * 1024 * 1024 * 1024
	GRPC_MAX_SEND_MSG_SIZE      = 2 * 1024 * 1024 * 1024
	GRPC_CALL_MAX_RECV_MSG_SIZE = 2 * 1024 * 1024 * 1024
	GRPC_CALL_MAX_SEND_MSG_SIZE = 2 * 1024 * 1024 * 1024
)
